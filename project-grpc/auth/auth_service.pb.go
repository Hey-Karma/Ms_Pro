...
var file_auth_service_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xaa, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65,
...
var file_auth_service_proto_depIdxs = []int32{
	...
	4, // 5: auth.service.v1.AuthService.AuthList:output_type -> auth.service.v1.ListAuthMessage
	3, // 6: auth.service.v1.AuthService.Apply:output_type -> auth.service.v1.ApplyResponse
